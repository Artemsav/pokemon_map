...
class Pokemon(models.Model):
    ...
    title_en = models.CharField(verbose_name='Англ. Название покемона',
                                max_length=200, blank=True,
                                )
    title_jp = models.CharField(verbose_name='Японск. Название покемона',
                                max_length=200, blank=True,
                                )
...
class PokemonElementType(models.Model):
    ...
    photo = models.ImageField(verbose_name='Изображение', null=True, blank=True)
    advantages = models.ManyToManyField('self', symmetrical=False,
